...
using VehicleRental.Microservice.Host.Configuration;
using VehicleRental.Microservice.Host.Infrastructure.Swagger;

namespace VehicleRental.Microservice.Host.DependencyInjection
{
